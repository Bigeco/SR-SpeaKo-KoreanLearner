...
const WORDS_DATASET = [
  "사과", "공룡", "안녕", "김치", "한국", "달걀", "토끼", "바다", "구름", "나무",
  "호랑이", "자동차", "기차", "도서관", "학교", "병원", "우유", "감자", "고구마", "강아지",
  "고양이", "버섯", "연필", "지우개", "종이", "우산", "모자", "장갑", "컵", "책상",
  "의자", "시계", "자전거", "계단", "창문", "문", "벽", "바닥", "천장", "나비",
  "참새", "고래", "강", "연못", "하늘", "별", "눈", "비", "바람", "불"
];

const WORDS_PRONUNCIATION = ["사과", "공뇽", "안녕", "김치", "한국", "달걀", "토끼", "바다", "구름", "나무",
"호랑이", "자동차", "기차", "도서관", "학꾜", "병원", "우유", "감자", "고구마", "강아지",
"고양이", "버섯", "연필", "지우개", "종이", "우산", "모자", "장갑", "컵", "책쌍",
"의자", "시계", "자전거", "계단", "창문", "문", "벽", "바닥", "천장", "나비",
"참새", "고래", "강", "연몯", "하늘", "별", "눈", "비", "바람", "불"];
